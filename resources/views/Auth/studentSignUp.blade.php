...
<body>
    ...
    <nav>
        <div class="nav-container">
            ...
            <div class="nav-right">
                <a href="{{route('teacher.signup')}}"> <button class="login">Signup as Teacher</button></a>
                <a href="{{route('homepage')}}"> <button class="signup">
    ...
    <div class="container">
        ...
        <a href="{{ route('student.login') }}">Already signed up? Log in</a>
    </div>
    ...
    async function checkEmailExists(email) {
        try {
            const response = await fetch(`{{ route('check.student.email') }}?email=${encodeURIComponent(email)}`);
